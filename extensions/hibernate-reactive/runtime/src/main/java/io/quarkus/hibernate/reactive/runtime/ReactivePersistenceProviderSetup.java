...
public final class ReactivePersistenceProviderSetup {
    ...
    public static void registerRuntimePersistenceProvider(HibernateReactiveRuntimeConfig hibernatereactiveRuntimeConfig,
        ...
        jakarta.persistence.spi.PersistenceProviderResolverHolder
                .setPersistenceProviderResolver(
                        new SingletonPersistenceProviderResolver(
                                new FastBootHibernateReactivePersistenceProvider(hibernatereactiveRuntimeConfig,
